...
@section('title', $event->title ?? 'Chi tiết nhạc sống')
...
<main class="booking-page">
    ...
    <section class="booking-hero">
        ...
        <div class="booking-hero-content">
            <span class="booking-kicker">Nhạc sống</span>
            <h1>{{ $event->title }}</h1>
            <div class="booking-meta">
                <span>{{ $event->event_date }}</span>
                <span>{{ $event->location }}</span>
                <span>{{ $event->event_type ?? 'Sự kiện âm nhạc' }}</span>
            </div>
        </div>
    </section>
    ...
    <div class="booking-grid">
        ...
        <aside class="booking-panel booking-side">
            ...
            @empty
                <div class="booking-empty">Sự kiện chưa có hạng vé.</div>
            @endforelse
        </aside>
    </div>
</main>
