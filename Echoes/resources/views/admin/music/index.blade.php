...
<table class="table table-bordered table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                @if($e->image)
                    <img src="{{ asset($e->image) }}" width="80" style="border-radius:4px">
                @else
            ...
            <td>
                <a href="{{ route('admin.music.edit', $e->id) }}" class="btn btn-sm btn-outline-primary">Sửa</a>
                <form action="{{ route('admin.music.destroy', $e->id) }}" method="POST" class="d-inline"
